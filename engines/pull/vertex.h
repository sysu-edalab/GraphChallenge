...
: neighbors(n), degree(d) {}
  ...
  inline uintE getInNeighbor(uintT j) { return neighbors[j]; }
  inline uintE getOutNeighbor(uintT j) { return neighbors[j]; }
...
#ifndef WEIGHTED
  inline uintE* getInNeighbors () { return inNeighbors; }
  inline uintE* getOutNeighbors () { return outNeighbors; }
  inline uintE getInNeighbor(uintT j) { return inNeighbors[j]; }
  inline uintE getOutNeighbor(uintT j) { return outNeighbors[j]; }
